...
import (
	...
	s3Config "bitbucket.org/asadventure/be-infrastructure-lib/s3/config"
	"github.com/aws/aws-sdk-go-v2/service/s3"

	"bitbucket.org/asadventure/be-infrastructure-lib/datatable/database"
	"bitbucket.org/asadventure/be-infrastructure-lib/datatable/elastic_search"

	"bitbucket.org/asadventure/be-core-lib/database/session"

	msg "bitbucket.org/asadventure/be-core-lib/pagination"
	appConfig "bitbucket.org/asadventure/be-infrastructure-lib/app/config"
	"bitbucket.org/asadventure/be-infrastructure-lib/database/config"
	elasticSearchConfig "bitbucket.org/asadventure/be-infrastructure-lib/elastic_search/config"
	grpcConfig "bitbucket.org/asadventure/be-infrastructure-lib/grpc/config"
	httpConfig "bitbucket.org/asadventure/be-infrastructure-lib/http/config"
	loggerConfig "bitbucket.org/asadventure/be-infrastructure-lib/logger/config"
	rabbitmqConfig "bitbucket.org/asadventure/be-infrastructure-lib/rabbitmq/config"
	redisConfig "bitbucket.org/asadventure/be-infrastructure-lib/redis/config"
	sqsConfig "bitbucket.org/asadventure/be-infrastructure-lib/sqs/config"
	stateMachineDomain "bitbucket.org/asadventure/be-infrastructure-lib/state_machine/instance/domain"
	tracerConfig "bitbucket.org/asadventure/be-infrastructure-lib/tracer/config"
