module github.com/guilhermealegre/pethub-gateway-service

go 1.22.7

require (
	bitbucket.org/asadventure/be-core-lib v0.0.0-20241022085706-fd0f997c0439
	bitbucket.org/asadventure/be-logging-service v0.0.0-20241114092435-f1a71da4a348
